          ...
          >
            <div className={styles.missionContent}>
              ...
              <p className={styles.missionTitle}>
                Datastride Analytics exists to prove that enterprise analytics doesn’t have to be slow, specialist‑only, or scattered across tools. We build Sia so any team can move from raw, messy data to reliable decisions quickly, with agentic AI handling the heavy lifting while people stay in control.
              </p>
            </div>
          </motion.div>
